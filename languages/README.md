...
Make sure you name your .mo files `gravity-pdf-developer-toolkit-{:wp_locale}.mo`, where {:wp_locale} is the ID found 
 in this list: https://make.wordpress.org/polyglots/teams/. 
 
For example, if you had a translation for Bengali you would name the file `gravity-pdf-developer-toolkit-bn_BD.mo`
